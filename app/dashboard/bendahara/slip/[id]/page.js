        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          ...
          <Card className="shadow-none border">
            ...
            <CardContent className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span>Tunjangan Pendidikan</span>
                <span>Rp {Number(data.tunjangan_pendidikan).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span>Tunjangan Pensiun</span>
                <span>Rp {Number(data.tunjangan_pensiun).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
                <span>Tunjangan Kelebihan Jam</span>
                <span>Rp {Number(data.tunjangan_jamlebih).toLocaleString()}</span>
              </div>
              <div className="flex justify-between">
