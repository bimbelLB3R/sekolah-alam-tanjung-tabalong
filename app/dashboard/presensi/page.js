...
//       {/* Tombol hanya muncul jika jarak <= 500 m */}
//       {distance !== null && distance <= maxDistance && (
...
//     // Jika GPS validation dinonaktifkan, skip GPS check
...
//     // Validasi GPS hanya jika fitur diaktifkan
//     if (gpsValidationEnabled) {
//       if (!latitude || !longitude) {
//         alert("Lokasi belum berhasil didapatkan. Coba ambil foto ulang.");
//         return;
...
//   // Tentukan apakah tombol bisa digunakan
...
//       {/* Info lokasi - hanya tampil jika GPS validation aktif */}
...
//       {/* Peringatan jarak - hanya jika GPS validation aktif */}
