...
export default function TabelManajemenTilawati({data,loading,dataSiswa,handleOpenAdd,dataUser,handleOpenEdit,handleSubmit,open,submitting, setOpen,form,setForm}) {
    ...
    <Card className="w-full overflow-hidden shadow-md rounded-2xl">
      <CardContent className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold">Daftar Peserta Tilawati</h2>
