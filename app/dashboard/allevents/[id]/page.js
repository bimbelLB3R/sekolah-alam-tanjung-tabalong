...
//             toast({
//         title: "Error",
//         description: "Gagal memuat data even",
//         variant: "destructive",
//         });
//     } finally {
//       setLoading(false);
...
//       toast({
//          title: "Berhasil!",
//       description: "Panitia berhasil ditambahkan",
//        });
//       setCommittees([...committees, result.data]);
//     } else {
...
//     const result = await EventAPI.updateCommitteeMember(eventId, committeeId, data);
//     if (result.success) {
//       // toast.success('Anggota panitia berhasil diupdate');
//       toast({
//          title: "Berhasil!",
//       description: "Panitia berhasil diupdate",
//        });
//       setCommittees(committees.map(c => c.id === committeeId ? result.data : c));
//     } else {
//       // toast.error(result.error);
...
//     const result = await EventAPI.deleteCommitteeMember(eventId, committeeId);
//     if (result.success) {
//       // toast.success('Anggota panitia berhasil dihapus');
//       toast({
//          title: "Berhasil!",
